        ...
        return (
            <Row className="main-login">
                <Col md={{ span: 24 }} lg={{ span: 12 }} className="f-col">
                    <div className="main">
                        ...
                        >
                            ...
                            >
                                <img alt="img" className="google-icon" src="https://upload.wikimedia.org/wikipedia/commons/5/53/Google_%22G%22_Logo.svg" />
                        Login with google
                </Button>
                ...
                <Col span={12} className="s-col">
                    ...
                    <img alt="img" src="https://image.freepik.com/free-vector/internship-job-illustration_23-2148722413.jpg" />
                </Col>
            </Row>
        );
    }
